...
class Detect:
    ...
    def load_model(self):
        ...
        # Pin DirectML to a specific GPU. device_id 0 is the discrete RX 7900 GRE;
        # id 1 is the weak Ryzen iGPU. Configurable via gpu_device_id so the wrong
    ...
    def preprocess_image(self, img):
        ...
        self._padded_img_buffer[0, :, :new_h, :new_w] = img_float.transpose(2, 0, 1)
