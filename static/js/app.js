...
function renderQueue() {
    ...
    const pushAllButton = `<button id="pushAllQueueBtn" class="btn" type="button">${iconMarkup("queue")} Push All to ${defaultTarget}</button>`;
        ...
        eaModal.innerHTML = `
            <div class="modal">
                <div class="modal-header">
                    ...
                    <p style="color: var(--text-secondary); font-size: 0.85rem; margin-top: 10px; line-height: 1.55;">This feature (such as Player Tag API integration and Advanced Debug Visuals) requires the <strong>Pyla Early Access</strong> module.</p>
